        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-2 md:pl-0 md:pt-4">
              ...
              <span className="text-xl font-black">Sign up for an account</span>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-2 md:pl-0 md:pt-4">
              ...
              <span className="text-xl font-black">Upload your PDF file</span>
              <span className="mt-2 text-zinc-700">
                We&apos;ll convert your PDF file into a chat-friendly format.
              </span>
            </div>
          </li>
          <li className="md:flex-1">
